...
O projeto final da disciplina consiste em testar uma hipótese evolutiva com o uso de métodos filogenéticos comparativos. Os estudantes poderão testar uma hipótese de interesse pessoal a partir dos seus próprios dados, ou testar uma hipótese pré-formulada a partir de dados de repositório. Em ambos casos, os estudantes deverão apresentar o desenvolvimento e a conclusões dos seus projetos. As apresentações dos projetos devem:
